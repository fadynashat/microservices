...
namespace Webhooks.API
{
    public class Startup
    {
        ...
        protected virtual void ConfigureEventBus(IApplicationBuilder app)
        {
            ...
            eventBus.Subscribe<EmployeeVacationChangedToApprovedIntegrationEvent, EmployeeVacationChangedToApprovedIntegrationEventHandler>();
        }
    }
    ...
    static class CustomExtensionMethods
    {
        ...
        public static IServiceCollection AddSwagger(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "FADYOnContainers - Webhooks HTTP API",
                    Version = "v1",
        ...
        public static IServiceCollection AddEventBus(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddTransient<EmployeeVacationChangedToApprovedIntegrationEventHandler>();
            return services;
        }
