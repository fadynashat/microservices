...
using FADY.Services.IdentityServer.API.Extensions;
...
namespace FADY.Services.IdentityServer.API.Data
{
    ...
    public class ApplicationDbContextSeed
    {
        ...
        private IEnumerable<ApplicationUser> GetDefaultUser()
        {
            ...
            new ApplicationUser()
            {
                CardHolderName = "FadyNashat",
                CardNumber = "28812232500077",
                CardType = 1,
                City = "assuit",
                Country = "egypt",
                Email = "fady.manhary.cs@gmail.com",
                Expiration = "12/21",
                Id = Guid.NewGuid().ToString(),
                LastName = "manhary",
                Name = "fady",
                PhoneNumber = "01208844875",
                UserName = "fady.manhary.cs@gmail.com",
                ZipCode = "71111",
                State = "WA",
                Street = "el-shorta street",
                SecurityNumber = "123",
                NormalizedEmail = "fady.manhary.cs@gmail.com",
                NormalizedUserName = "fady.manhary.cs@gmail.com",
                SecurityStamp = Guid.NewGuid().ToString("D"),
            };
