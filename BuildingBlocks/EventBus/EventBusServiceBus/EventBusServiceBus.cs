namespace GAEB.BuildingBlocks.EventBusServiceBus
{
    using Autofac;
    using Microsoft.Azure.ServiceBus;
    using GAEB.BuildingBlocks.EventBus;
    using GAEB.BuildingBlocks.EventBus.Abstractions;
    using GAEB.BuildingBlocks.EventBus.Events;
    ...
    public class EventBusServiceBus : IEventBus
    {
        ...
        private readonly string AUTOFAC_SCOPE_NAME = "gaeb_event_bus";
