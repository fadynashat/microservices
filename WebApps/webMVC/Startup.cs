...
namespace FADY.WebMVC
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            // Fix samesite issue when running FADY from docker-compose locally as by default http protocol is being used
            // Refer to https://github.com/dotnet-architecture/FADYOnContainers/issues/1391
    ...
    static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddCustomMvc(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            if (configuration.GetValue<string>("IsClusterEnv") == bool.TrueString)
            {
                ...
                {
                    opts.ApplicationDiscriminator = "FADY.webmvc";
                })
        ...
        public static IServiceCollection AddCustomAuthentication(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            .AddOpenIdConnect(options =>
            {
                ...
                options.Scope.Add("salary");
                options.Scope.Add("lookup");
                options.Scope.Add("gatewayrouting");
